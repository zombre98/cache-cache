...
/*
 * Swap the parent when kid is smaller than it's parent
 * Note that heap_idx is updated through ref pointer while swapping
 */
...
/*
 * Update a position. It is used for updating, inserting, and deleting
 */
